...
try
{
 ...
 rs=CBean.executeQuery("select c.complaint_id,c.prob_desc,c.status,p.area,c.ctype,to_char(c.cdate,'dd-mm-yyyy') from complaint_reg c ,police_department p  where c.customer_id=" + regid + " and p.department_id=c.department_id and to_date(c.cdate,'dd-Mon-yy') between  '" + fdt + "' and '" + tdt + "' and c.ctype='" + ctype + "' order by complaint_id ");
%>
...
<tr>
<td><input type=submit value="Search"  onclick="return CheckInput()"><input type=submit value="Show All"  onclick="Go()"></td>
</tr>
