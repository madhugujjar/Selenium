...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
      <TD width="21%"
      background="Images/mbg.gif"><b><font color="#000066">Department Information</font></b></TD>
      <TD width="55%" background="Images/mbg.gif"> 
...
color=#000066> <b> Home Page</b></font></a> |<a href="Complaints.jsp" ><FONT 
color=#000066> <b>Requested 
        Complaints </a> | <a href="DThievesInformation.jsp"><FONT 
color=#000066> <b> Criminals Information</b></font></a> 
        |<a href="Customers.jsp"><FONT 
color=#000066> <b>Customer Information</b></font></a> 
        </TD>
    ...
    background="Images/mgbg.gif" height=20 width="24%"> 
        ...
        <IMG height=8 hspace=10 src="Images/bullet.gif" width=8 align=absMiddle border=0><a href="HomePage.jsp"><FONT 
